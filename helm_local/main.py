...
lora_path='path or your lora weights'
model_path = 'path to your local path of qwen 14b or Qwen/Qwen-14B'
device='cuda:0'
...
# nohup helm-run --conf-paths bench.conf --suite bench --max-eval-instances 1000 > run.log &
