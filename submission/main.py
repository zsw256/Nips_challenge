...
lora_path='Rocinante/qwen_merge'
...
# nohup uvicorn main:app --host 0.0.0.0 --port 8080 > server.out &
# nohup helm-run --conf-paths test.conf --suite bench --max-eval-instances 1000 > run.out &
